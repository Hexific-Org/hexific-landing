...
export function DocsLayout({
    ...
    return (
        <div className="min-h-screen bg-[#000E1B]">
            ...
            {/* Main Content */}
            <main className={`lg:ml-64 ${rightSidebar ? 'xl:mr-64' : ''} pt-28 px-4 sm:px-6 lg:px-8 py-12`}>
                <div className="max-w-4xl mx-auto">{children}</div>
            </main>

            {/* Footer */}
            <footer className={`lg:ml-64 ${rightSidebar ? 'xl:mr-64' : ''} border-t border-gray-800 mt-20 bg-[#000E1B]`}>
