...
export default function SiteFooter({ onScrollToContact }: SiteFooterProps) {
  return (
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Advanced smart contract security auditing platform powered by AI and expert analysis.
            </p>
          </div>
          <div>
            <h4 className="font-semibold mb-4 text-gray-300 text-sm uppercase tracking-wider">Services</h4>
            <ul className="space-y-2 text-sm text-gray-600">
              <li onClick={onScrollToContact}>
                <a className="hover:text-gray-300 hover:cursor-pointer transition-colors">Smart Contract Audits</a>
              </li>
              <li>
                <a
                  href="#"
              ...
              <li>
                <a href="/manual-audit" className="hover:text-gray-300 transition-colors">
                  Security Consulting
                </a>
              </li>
              <li>
