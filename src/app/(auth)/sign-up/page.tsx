    ...
    <div className="min-h-screen bg-[#000E1B] flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="glass-effect rounded-2xl p-8 border border-lime-400/20 shadow-xl">
          ...
          <p className="text-gray-400 text-center mb-6">Sign up to access HexiLearn, track progress, and earn certificates</p>
          ...
          <p className="mt-6 text-center text-gray-400 text-sm">
            ...
            <Link href={`/sign-in?redirect=${encodeURIComponent(redirectTo)}`} className="text-lime-400 hover:text-lime-300 font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
